...
export const Navbar: React.FC = () => {
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
      <nav className="pointer-events-auto w-full max-w-[1160px] bg-white/60 backdrop-blur-2xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/50 px-2 md:px-3 h-[64px] flex items-center justify-between transition-all duration-300 hover:bg-white/80">
        ...
        {/* Mobile Menu Button */}
        <button className="md:hidden text-gray-800 p-2 hover:bg-black/5 rounded-md mr-1">
          <Menu size={24} />
        </button>
      </nav>
    </div>
